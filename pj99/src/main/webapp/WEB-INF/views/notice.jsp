			...
			<div class="col-xs-12">
				...
				<c:when test="${uid=='admin' || uid=='master'}">
					<div class="col-sm-4" align="left">
						<button class="btn btn-default" onclick="location.href='recordinController'">공지사항 등록</button>
					</div>
				</c:when>
				<c:otherwise>
					<div class="col-sm-4" align="left">
						<button class="btn btn-default disabled" onclick="location.href=''">공지사항 등록</button>
					</div>
				</c:otherwise>
				</c:choose>	
